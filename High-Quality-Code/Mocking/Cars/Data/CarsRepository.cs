namespace Cars
{
    ...
    public class CarsRepository : ICarsRepository
    {
        ...
        public void Add(Car car)
        {
            if (car == null)
            {
                throw new ArgumentNullException("Null car cannot be added");
            }
        ...
        public void Remove(Car car)
        {
            if (car == null)
            {
                throw new ArgumentNullException("Null car cannot be removed");
            }
        ...
        public Car GetById(int id)
        {
            ...
            if (car == null)
            {
                throw new ArgumentNullException("Car with such Id could not be found");
            }
