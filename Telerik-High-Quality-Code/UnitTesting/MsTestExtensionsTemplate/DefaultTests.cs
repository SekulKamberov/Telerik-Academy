namespace MsTestExtensionsTemplate
{
    using System;
    using System.Data;
    ...
    public class DefaultTests
    {
        ...
        /// <summary>
        /// MsTestExtensions package
        /// </summary>
        [TestMethod]
        public void IntParse_ParseInvalidInput_ShouldThrowException()
        {
            // ARRANGE
            var input = "not a number";
            ...
            // ASSERT
            ThrowsAssert.Throws<FormatException>(() => int.Parse(input));
        }
    }
}
